...
const NewProduct = ({ postData }) => {
  ...
  return <div className="container col col-lg-6 my-4 rounded-2  bg-light bg-opacity-50" >
    ...
    <form onSubmit={handleSubmit}>
      <div className="mt-4">
        ...
        <div className="text-center my-4">
          <button
            type="submit" className="btn btn-success w-25"><FaCartPlus /> Save to New Product</button>
        </div>
        <div className="text-center">
          <button
            onClick={() => navigate("/productlist")}
            type="submit" className="btn btn-primary mb-4 w-25"><FaCartPlus />  Go to the Product List</button>
        </div>
      </div>
    </form>
  </div>;
